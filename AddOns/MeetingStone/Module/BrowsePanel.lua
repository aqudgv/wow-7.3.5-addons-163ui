...
function BrowsePanel:OnInitialize()
    ...
    local LootDropdown = GUI:GetClass('Dropdown'):New(self) do
        ...
        local levelTable = { { value = 0, text = "不屏蔽" }, { value = 1, text = "屏蔽无要求队伍" }, { value = 800, text = "低于800" }, { value = 850, text = "低于850" }, }
        for i=900, 970, 10 do
...
function BrowsePanel:Search()
    ...
    local searchText = self:GetSearchCode(fullName, self.ModeDropdown:GetValue(), 0, --[[self.LootDropdown:GetValue(),]] activityItem.customId)
