...
L["  /dcstats config: Opens the DejaCharacterStats addon config menu."] = "/dcstats config: 打开DejaCharacterStats设置菜单。"
L["  /dcstats reset:  Resets DejaCharacterStats options to default."] = "/dcstats reset: 重置DejaCharacterStats选项为预设。"
...
L["Avoidance Rating"] = "闪避点数"
L["Blizzard's Hide At Zero"] = "以暴雪方式隐藏0值"
L["Character Stats:"] = "角色属性："
L["Class Colors"] = "职业颜色"
L["Class Crest Background"] = "职业纹章背景"
L["Critical Strike Rating"] = "暴击点数"
L["DCS's Hide At Zero"] = "以DCS方式隐藏0值"
L["Decimals"] = "小数"
L["Defense"] = "防御"
...
L["Displays average item level to one decimal place."] = "显示平均装等后一位小数"
L["Displays average item level to two decimal places."] = "显示平均物品等级到小数点后二位。"
...
L["Displays the class crest background."] = "显示职业纹章背景。"
...
L["Expand"] = "展开"
L["General"] = "通用"
L["General global cooldown refresh time."] = "一般通用冷却刷新时间。"
L["Global Cooldown"] = "公共冷却"
L["Haste Rating"] = "急速点数"
L["Hide Character Stats"] = "隐藏人物属性"
L["Hides \"Enhancements\" stats if their displayed value would be zero. Checking \"Decimals\" changes the displayed value."] = [=[隐藏"強化"属性如果它们的值为零。
勾选"小数点"会改变显示的数值。]=]
L["Hides \"Enhancements\" stats only if their numerical value is exactly zero. For example, if stat value is 0.001%, then it would be displayed as 0%."] = [=[隐藏"强化"属性只有当它们的数值完全为零时。
举例，如果属性数值为0.001%，那么它将显示为0％。]=]
L["Item Durability"] = "物品耐久度"
L["Item Level"] = "物品等级"
L["Item Repair Cost"] = "物品修理费用"
L["Item Slots:"] = "物品栏位："
L["Leech Rating"] = "吸血点数"
L["Lock DCS"] = "锁定DCS"
L["Main Hand"] = "主手"
L["Mastery Rating"] = "精通点数"
L["Miscellaneous:"] = "杂项："
L["Movement Speed"] = "移动速度"
L["Off Hand"] = "副手"
L["Offense"] = "设置"
...
L["Two Decimal Places"] = "两位小数"
L["Unlock DCS"] = "解锁DCS"
L["Versatility Rating"] = "全能点数"
