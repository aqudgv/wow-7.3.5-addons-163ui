...
function CollectMe:OnInitialize()
    --bindings
    BINDING_HEADER_COLLECTME = self.L["CollectMe"]
	...
	self:RegisterChatCommand("收藏", "SlashProcessor")
	self:RegisterChatCommand("收藏進度", "SlashProcessor")
...
function CollectMe:SlashProcessor(input)
    ...
    elseif input == "options" then
        InterfaceOptionsFrame_OpenToCategory(self.L["CollectMe"])
