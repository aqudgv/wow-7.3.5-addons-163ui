...
function CollectMe.UI:Build()
    ...
    f:SetTitle(self.L["Collect Me "] .. CollectMe.VERSION)
    f:SetWidth(570)
    f:SetLayout("List")
    ...
    profilebutton:SetScript("OnClick", function() InterfaceOptionsFrame_OpenToCategory(self.L[CollectMe.ADDON_NAME]) InterfaceOptionsFrame_OpenToCategory(self.L[CollectMe.ADDON_NAME]) end)
