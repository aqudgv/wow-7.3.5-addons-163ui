...
function Config:OnInitialize()
    ...
    local aboutpanel = about_panel.new(nil, addon_name)
	aboutpanel.name = L[addon_name]

    ac:RegisterOptionsTable(addon_name .. " LDB", GetLdbOptionsTable())
    acd:AddToBlizOptions(addon_name .. " LDB", L["Data Broker Options"], L[addon_name])

    ac:RegisterOptionsTable(addon_name .. " Macros", GetMacroOptionsTable())
    acd:AddToBlizOptions(addon_name .. " Macros", L["Macros"], L[addon_name])

    ac:RegisterOptionsTable(addon_name .. " Pet Battles", GetPetBattleOptionsTable())
    acd:AddToBlizOptions(addon_name .. " Pet Battles", L["Pet Battles"], L[addon_name])

    ac:RegisterOptionsTable(addon_name .. " Profiles", LibStub("AceDBOptions-3.0"):GetOptionsTable(db))
    acd:AddToBlizOptions(addon_name .. " Profiles", L["Profiles"], L[addon_name])
end
