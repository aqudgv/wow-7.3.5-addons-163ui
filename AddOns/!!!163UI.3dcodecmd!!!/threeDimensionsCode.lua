...
•
e.texture:SetColorTexture(unpack(a.keepAlive))
e.texture:SetAllPoints(e)
t.texture:SetColorTexture(unpack(a.keepAlive))
t.texture:SetAllPoints(t)
ß
ß,
desireWidth=™()
e.texture:SetColorTexture(unpack(a.desireWidth))
e.texture:SetAllPoints(e)
t.texture:SetColorTexture(unpack(a.desireWidth))
t.texture:SetAllPoints(t)
ß,
receiving=™()
e.texture:SetColorTexture(unpack(a.receiving))
e.texture:SetAllPoints(e)
t.texture:SetColorTexture(unpack(a.receiving))
t.texture:SetAllPoints(t)
ß,
hide=™()
e:Hide()
...
e=a[t+1];
ß
e.texture:SetColorTexture(self:color(1),self:color(2),self:color(3),1)
e.texture:SetAllPoints(e)
t=t+1
≠ ™ e(e)
≤ e ¢ string.char(e)∞""
