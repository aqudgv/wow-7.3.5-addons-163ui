...
local Main = Addon.Panel:New('CombuctorOptions', '分类背包整合', L.OptionsSubtitle)
local panels = {}
...
function Addon:NewPanel(name)
	local panel = Addon.Panel:New('CombuctorOptions' .. name, '分类背包整合', L.OptionsSubtitle, nil, '分类背包整合', L[name])
