...
local whisp100 = "网.易.有.爱: 刚100级的角色无法密语我，请通过其他方式联系。"

do
	local L = GetLocale()
	if L == "zhTW" then
		whisp = "网.易.有.爱: 你起碼要達到 %d 級才能密我。"
		err = "你的好友列表滿了，按等级过滤需要你騰出2個好友空位!"
	elseif L == "zhCN" then
		whisp = "网.易.有.爱: 你起码要达到 %d 级才能和我讲话。"
...
ChatFrame_AddMessageEventFilter("CHAT_MSG_WHISPER_INFORM", function(_,_,msg,player)
    ...
    if filterTable[trimmedPlayer] and msg:find("^网.易.有.爱.*"..filterTable[trimmedPlayer]) then return true end --Filter auto-response
