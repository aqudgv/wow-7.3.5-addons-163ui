                ...
                Texture = {
                  ...
                  args = {
                    ...
                    Style = {
                      ...
                      values = { default = L["Default"], skullandcross = L["Skull and Crossbones"] },
                      set = function(info, val)
                        SetThemeValue(info, val)
...
--                  disabled = function() if db.targetWidget.ON then return false else return true end end,
                  args = {
                    ...
                    Select = {
                      ...
                      values = { default = L["Default"], squarethin = L["Thin Square"], arrows = L["Arrows"], crescent = L["Crescent"], bubble = L["Bubble"] },
                      arg = { "targetWidget", "theme" },
                    },
                    Color = {
                      name = L["Color"],
...
--            },
  ...
  local ClassOpts = {
    Style = {
      ...
      values = { default = L["Default"], transparent = L["Transparent"], },
...
--            Spacer3 = GetSpacerEntry(24),
            Header = { type = "header", order = 24, name = L["Threat Options"], },
            ThreatGlow = {
              name = L["Threat Glow"],
              order = 31,
              type = "toggle",
