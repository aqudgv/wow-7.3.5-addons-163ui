...
local function ArtifactPowerTruncate(power)
	...
	if power >= 200000000 then
		return floor(power / 100000000) .. "億"
	elseif power >= 100000000 then
		return (floor(power / 10000000) / 10) .. "億"
	elseif power >= 20000 then
		return floor(power / 10000) .. "萬"
	elseif power >= 10000 then
		return (floor(power / 1000) / 10) .. "萬"
	elseif power >= 20000 then
		return floor(power / 1000) .. "千"
	elseif power >= 1000 then
		return (floor(power / 100) / 10) .. "千"
	else
		return power
	end
end
