...
addon.hiddenOptions = {
	...
	["nameplateShowFriendlyNPCs"] = { prettyName = "友方 NPC", description = "總是顯示友方 NPC 的名條。", type = "boolean" },
	...
	["nameplateOtherAtBase"] = { prettyName = "血條在下方", description = "其他血條顯示在腳下，而不是頭頂。 2=下方, 0=頭頂", type = "boolean" },
	...
	["nameplateMaxDistance"] = { prettyName = "血條視野距離", description = "可以看見多遠範圍內的血條。", type = "number" },
	...
	["nameplateOtherTopInset"] = { prettyName = "其他血條上方間距", description = "The inset from the top (in screen percent) that the non-self nameplates are clamped to.", type = "number" },
	...
	["ShowClassColorInFriendlyNameplate"] = { prettyName = "友方血條顯示職業顏色", description = "使用職業顏色來顯示友方的血條。", type = "boolean" },
